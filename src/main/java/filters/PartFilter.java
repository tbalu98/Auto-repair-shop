...
public class PartFilter {
    ...
    public PartFilter(Integer id, String nev, Integer ar, Integer garanciaIdotartama, Integer cikkszam) {
        this.id = id;
        this.nev = nev;
        this.ar = ar;
    ...
    public PartFilter(String nev, String ar, String garanciaIdotartama, String cikkszam){
